...
yy: {},
symbols_: {"error":2,"expressions":3,"e":4,"EOF":5,"(":6,")":7,"|":8,"&":9,"!":10,"XNAME":11,"ARGS":12,"NAME":13,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",6:"(",7:")",8:"|",9:"&",10:"!",11:"XNAME",12:"ARGS",13:"NAME"},
productions_: [0,[3,2],[4,3],[4,3],[4,3],[4,2],[4,2],[4,2],[4,1]],
performAction: function anonymous(yytext,yyleng,yylineno,yy,yystate,$$,_$) {

var $0 = $$.length - 1;
switch (yystate) {
case 1: return flatten($$[$0-1]);  
break;
case 2:  this.$ = [ '(' , $$[$0-1] , ')' ];  
break;
case 3:  this.$ = [ $$[$0-2] , '||' , $$[$0] ]; 
...
break;
case 6: 
            this.$ = [ { name : '@' , elemName : $$[$0-1].slice(1) , value : $$[$0].slice(0,$$[$0].length-1).slice(1) } ]; 
...
table: [{3:1,4:2,6:[1,3],10:[1,4],11:[1,5],13:[1,6]},{1:[3]},{5:[1,7],8:[1,8],9:[1,9]},{4:10,6:[1,3],10:[1,4],11:[1,5],13:[1,6]},{4:11,6:[1,3],10:[1,4],11:[1,5],13:[1,6]},{12:[1,12]},{5:[2,8],7:[2,8],8:[2,8],9:[2,8],12:[1,13]},{1:[2,1]},{4:14,6:[1,3],10:[1,4],11:[1,5],13:[1,6]},{4:15,6:[1,3],10:[1,4],11:[1,5],13:[1,6]},{7:[1,16],8:[1,8],9:[1,9]},{5:[2,5],7:[2,5],8:[2,5],9:[2,5]},{5:[2,6],7:[2,6],8:[2,6],9:[2,6]},{5:[2,7],7:[2,7],8:[2,7],9:[2,7]},{5:[2,3],7:[2,3],8:[2,3],9:[2,3]},{5:[2,4],7:[2,4],8:[2,4],9:[2,4]},{5:[2,2],7:[2,2],8:[2,2],9:[2,2]}],
